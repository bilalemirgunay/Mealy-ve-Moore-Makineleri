 ...
 * @author gunay
 */
public class MooreArayuz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        aiBilgiLabel.setText("After Inputs");
        ...
        cpBilgiLabel.setText("Character Printed");
        ...
        characterPrintedOrnek.setText("1\n0\n0\n1");
    ...
    public void tabloBilgileriniAl(){
        ...
        String cpParca[] = characterPrintedTA.getText().trim().split("\n"); 
        String aiParca[];
        ...
        for(int i=0; i<cpParca.length; i++){
            durumlar[i].durumCiktisi = cpParca[i];
        }
     ...
     public void sonucuYaz(){
        ...
        String output = anlikDurum.durumCiktisi;
        ...
        for(int i=0; i<inputString.length(); i++){
            ...
            output += anlikDurum.durumCiktisi;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MooreArayuz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MooreArayuz().setVisible(true);
            }
        });
    }
